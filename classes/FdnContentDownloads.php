 ...
 */
class FdnContentDownloads extends \ContentElement
{
	...
	protected function compile()
	{
		...
		$this->Template->fdnBlockClass = '';
		$this->Template->fdnAttributes = '';

		if($this->useFoundationBlockGrid)
		{
			$this->Template->fdnBlockClass  = 'row small-up-'.$this->fdn_smallBlock.' '.'medium-up-'.$this->fdn_mediumBlock.' '.'large-up-'.$this->fdn_largeBlock;
			
			if(!empty($this->fdn_classes)) {
				$this->Template->fdnBlockClass .= ' '.trim($this->fdn_classes);
			}
